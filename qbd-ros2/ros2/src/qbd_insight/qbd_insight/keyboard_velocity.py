...
# https://github.com/ros2/teleop_twist_keyboard/blob/rolling/teleop_twist_keyboard.py
...
class KeyboardVelocity(Node):
    def __init__(self) -> None:
        ...
        # 将速度信息发布到 /qbd_insight/keyboard_velocity，接口类型是 QBDSimpleKeyboardInfo
        self.pub = self.create_publisher(QBDSimpleKeyboardInfo, "/qbd_insight/keyboard_velocity", 1)
